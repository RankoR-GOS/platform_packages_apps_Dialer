...
internal class IsContactsPermissionGrantedImplTest {
    ...
    fun invoke_asksTheHelperOnEveryCall() {
        ...
        verify(exactly = 2) { PermissionsUtil.hasContactsReadPermissions(context) }
    }

    private fun createUseCase(): IsContactsPermissionGrantedImpl {
        return IsContactsPermissionGrantedImpl(context = context)
    }
}
